  ...
  return (
    ...
    >
      <div className="mb-6 h-1 w-40 overflow-hidden rounded-full bg-sunken">
        <div className="h-full w-full origin-left animate-[scan_0.6s_ease-in-out_infinite] bg-brand" />
      </div>
      <p className="tabular text-sm text-text-muted">Analyzing flow…</p>
      ...
      <style>{`
        ...
        @media (prefers-reduced-motion: reduce) {
          .animate-\\[scan_0\\.6s_ease-in-out_infinite\\] { animation: none; transform: scaleX(0.5); }
        }
      `}</style>
    </div>
  );
